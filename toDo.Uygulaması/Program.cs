...
namespace toDo.Uygulamasi
{
    ...
    {   
        ...
        //{   new KartBilgileri() {Baslik="Bozkart",Icerik="Otobüs Kartı",Büyüklük="xL",AtananKisi="Sami Yagmur"}
        ...
        //{
        //    new KartBilgileri() {Baslik="Ankart",Icerik="Otobüs Kartı",Büyüklük="xL",AtananKisi="Fırat Kaya"}

        //};

        //public static List<KartBilgileri> done = new List<KartBilgileri>()
        //{
        //    new KartBilgileri() {Baslik="Denkart",Icerik="Otobüs Kartı",Büyüklük="xL",AtananKisi="Yılmaz Sağlam"}
        ...
        //    var atananKisiVarmiTodo = todo.FindAll(x => x.AtananKisi == AtananKisi);
        //    var atananKisiVarmiInProgress = inProgress.FindAll(x => x.AtananKisi == AtananKisi);
        //    var atananKisiVarmiDone = done.FindAll(x => x.AtananKisi == AtananKisi);

        //    if ((atananKisiVarmiTodo != null) && (atananKisiVarmiInProgress != null) && (atananKisiVarmiDone != null))
        //    {
        //        todo.Add(new KartBilgileri()
        //        {
        //            Baslik = Baslik,
        //            Icerik = Icerik,
        //            Büyüklük = Büyüklük,
        ...
        //    var atananKisiVarmiTodo = todo.FindAll(x => x.Baslik == Baslik);
        //    var atananKisiVarmiInProgress = inProgress.FindAll(x => x.Baslik == Baslik);
        //    var atananKisiVarmiDone = done.FindAll(x => x.Baslik == Baslik);

        //    if ((atananKisiVarmiTodo != null) && (atananKisiVarmiInProgress != null) && (atananKisiVarmiDone != null))
        //    {
        //        todo.Remove(new KartBilgileri() // parametrisz yazılırmı ?//aynı isimden birden fazla ikişiye bak.
        //        { Baslik = Baslik, 
        //          Icerik = Icerik, 
        //          Büyüklük = Büyüklük, 
        //          AtananKisi = AtananKisi });
        ...
        //    var atananKisiVarmiTodo = todo.Find(x => x.Baslik == Baslik);
        //    var atananKisiVarmiInProgress = inProgress.Find(x => x.Baslik == Baslik);
        //    var atananKisiVarmiDone = done.Find(x => x.Baslik == Baslik);
        //    int atananKisiVarmiTodoIndex = todo.IndexOf(atananKisiVarmiTodo);
        //    int atananKisiVarmiInProgressIndex = todo.IndexOf(atananKisiVarmiInProgress);
        //    int atananKisiVarmiDoneIndex = todo.IndexOf(atananKisiVarmiDone);

        //    if ((atananKisiVarmiTodoIndex != -1) && (atananKisiVarmiInProgress != null) && (atananKisiVarmiDone != null))
        //    {
        //        if ((atananKisiVarmiTodoIndex != -1))
        //        {
        //            todo[atananKisiVarmiTodoIndex].Insert(new KartBilgileri() // parametrisz yazılırmı ?//aynı isimden birden fazla ikişiye bak.//burda kaldın.
        //            {
        //                Baslik = Baslik,
        //                Icerik = Icerik,
        //                Büyüklük = Büyüklük,
